...
export default {
  ...
  setup(props) {
    ...
    function ratingWidthStyle() {
      return `width: ${this.ratingWidth()}%;`;
    }
    return { ratingWidth, ratingWidthStyle };
  },
};
</script>
...
.star {
  ...
  &--colored {
    background: url("../img/StarColored.svg") center no-repeat;
  }

  &--outlined {
    background: url("../img/StarOutlined.svg") center no-repeat;
  }
}
</style>
